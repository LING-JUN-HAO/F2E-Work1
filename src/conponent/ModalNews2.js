...
const ModalNews2 = ({ setNewsModal, setBodyStyle }) => {
        ...
        <div className="ModalContainer" onClick={handleContainerClick}>
            ...
            <div className="ModalBox">
                <div className="ModalImageBox">
                    <img src={news2} alt="掃街模式開啟！帶著你的貓耳，來和我一起走！" className='NewsPhoto' />
                    <div className="ModalImageContentBox">
                        <span>掃街模式開啟！帶著你的貓耳，來和我一起走！</span>
                        <div className="Share">
                            分享
