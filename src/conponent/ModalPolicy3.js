...
const ModalPolicy3 = ({ setNewsModal, setBodyStyle }) => {
        ...
        <div className="ModalContainer" onClick={handleContainerClick}>
            ...
            <div className="ModalBox">
                <div className="ModalImageBox">
                    <img src={policy3} alt="推廣寵物飼養教育，讓愛更加專業" className='PolicyPhoto' />
                    <div className="ModalImageContentBox">
                        <span>推廣寵物飼養教育，讓愛更加專業</span>
                        <div className="Share">
                            分享
