...
const ModalPolicy2 = ({ setNewsModal, setBodyStyle }) => {
        ...
        <div className="ModalContainer" onClick={handleContainerClick}>
            ...
            <div className="ModalBox">
                <div className="ModalImageBox">
                    <img src={policy2} alt="打造休閒天堂！推廣寵物休閒與娛樂場所" className='PolicyPhoto' />
                    <div className="ModalImageContentBox">
                        <span>打造休閒天堂！推廣寵物休閒與娛樂場所</span>
                        <div className="Share">
                            分享
                    ...
                    <div className='MoreBox'>
                        ...
                        <div className="MoreInfo">
                            <div className="ImageContainer">
                                <img src={policy1} alt="為毛孩子謀福利！推動寵物醫療保障方案" />
                                <p>為毛孩子謀福利！推動寵物醫療保障方案</p>
                            </div>
                            <div className="ImageContainer">
